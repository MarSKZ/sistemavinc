                                        ...
                                        <table class="table-responsive table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                            <thead class="bg-primary">
                                                <tr class=" text-start text-gray-400 fw-bold fs-7  gs-0">
                                                    ...
                                                    <th class="textoTabla min-w-50px">Nombre Proceso</th>
                                                    <th class="textoTabla min-w-50px">Nombre Documento</th>
                                                    <th class="textoTabla min-w-50px">Docoumento PDF</th>
                                                    <th class="textoTabla min-w-50px">Estatus PTC</th>
                                                    <th class="textoTabla min-w-50px">Periodo</th>
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                foreach ($solicitudes as $row) {
                                                    ...
                                                    echo '
                                                        <a href="?c=ptc&a=pdf&id=' . $row['Matricula'] . '&id2=' . $row['IdDocumento'] . '" target="_Blank" class="btn btn-sm btn-warning me-3" id="openPdfButton">Mostrar PDF</a>
                                                    ...
                                                    // ';
                                                     echo ' <a href="?c=ptc&a=validarDoc&id='.$row['Matricula'].'&id2='.$row['IdDocumento'],'" class="btn btn-sm btn-success me-3" id="openPdfButton">Validar</a>
                                                    //  <a href="?c=ptc&a=descartarDoc&id='.$row['Matricula'].'&id2='.$row['IdDocumento'],'" class="btn btn-sm btn-danger me-3" id="openPdfButton">Anular</a>
                                                     ';
