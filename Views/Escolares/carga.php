											...
											<table class="table-responsive table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												<thead class="bg-primary">
													<tr  class=" text-start text-gray-400 fw-bold fs-7  gs-0">
														...
														<th class="textoTabla min-w-50px">Apellido Paterno</th>                                                        
														<th class="textoTabla min-w-50px">Apellido Materno</th>
														...
														<th class="textoTabla min-w-50px">Proceso</th>
														<th class="textoTabla min-w-50px">Estatus Vinculación</th>                                                        
